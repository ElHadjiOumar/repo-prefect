...
def dbt_task():
    result = DbtCoreOperation(
        ...
        commands=["dbt run --models onepointpariscurrent onepointparishistorical onepointparisunion --target dev","parissilverview parissilverincr parissilverunion --target silver"],
