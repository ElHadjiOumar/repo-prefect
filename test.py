...
def dbt_task():
    result = DbtCoreOperation(
        ...
        commands=["dbt run --models onepointpariscurrent onepointparisincr onepointparisunion --target dev","dbt run --models parissilverview parissilverincr parissilverunion --target silver"],
