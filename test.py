...
def dbt_task():
    result = DbtCoreOperation(
        commands=["dbt run --models onepointparis onepointrennes onepointbordeaux onepointmontreal --target dev","dbt run --models bordeauxsilver montrealsilver parissilver rennessilver --target silver","dbt run --models weathergold --target gold"],
